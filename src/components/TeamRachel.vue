    ...
    <div class="w-full px-1 md:w-4/5 md:mx-auto lg:w-1/2">
        <div class="bg-white py-6 mt-2 flex flex-col rounded-xl">
            <div class="flex items-center">
                ...
                <div><h2 class="text-xl font-roboto font-bold custom-text-color pl-6">Hon. Rachel E. Freier,<br>AEMT-Paramedic</h2></div>
            </div>
            <div>
            ...
            <div class="px-1 md:px-2 xl:px-8">
                ...
                After graduating law school, Rachel founded Chasdei Devorah, Inc. a non profit charity, in memory of her friend who passed away at a young age. Thereafter she formed B’Derech, a grassroots non profit organization advocating for education and opportunity for adolescents in the Chassidic community.<br><br>
                ...
                Rachel is a proud, devoted mother and grandmother of a Chassidic Family. She is dedicated to her Chassidic community specifically and reaches out to the general Jewish community.</p>
            </div>
        </div>
    </div>
</template>
